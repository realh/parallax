...
public final class SkinSimpleShader extends Shader 
{
	static class Resources extends DefaultResources
	{
		...
		{
			return uk.co.realh.parallax.shaders.skin_simple.vertex;
		}

		@Override
		public String getFragmentShader()
		{
			return uk.co.realh.parallax.shaders.skin_simple.fragment;
		}
	}
	...
	public SkinSimpleShader() 
	{
		...
		setFragmentExtensions("#extension GL_OES_standard_derivatives : enable\n");
	}
