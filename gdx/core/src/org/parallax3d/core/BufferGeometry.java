...
import org.parallax3d.renderer.IndexTypeArray;
import org.parallax3d.renderer.Int32Array;
...
public class BufferGeometry extends AbstractGeometry
{
	...
	public BufferGeometry fromGeometry( Geometry geometry, Material.COLORS vertexColors) {
		...
		if ( vertexColors != Material.COLORS.NO ) {
			...
			this.addAttribute("build/intermediates/exploded-aar/com.android.support/appcompat-v7/23.0.1/res/color", new BufferAttribute( colors, 3 ) );
