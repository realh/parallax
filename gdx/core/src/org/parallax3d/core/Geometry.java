...
import org.parallax3d.math.Box3;
...
import org.parallax3d.objects.Bone;
...
public class Geometry extends AbstractGeometry
{
	...
	public Geometry fromBufferGeometry( BufferGeometry geometry ) 
	{
		...
		Float32Array colors = geometry.getAttribute("build/intermediates/exploded-aar/com.android.support/appcompat-v7/23.0.1/res/color") != null
				? (Float32Array)geometry.getAttribute("build/intermediates/exploded-aar/com.android.support/appcompat-v7/23.0.1/res/color").getArray() : null;
